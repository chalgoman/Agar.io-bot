...
var sha = "b5d8747508ae80dffdf57e0857b388dbb97176f3";
function getLatestCommit() {
    window.jQuery.ajax({
            ...
            window.jQuery.get('https://raw.githubusercontent.com/chalgoman/Agar.io-bot/master/launcher.user.js?' + Math.floor((Math.random() * 1000000) + 1), function(data) {
                ...
                var script1 = "https://cdn.rawgit.com/chalgoman/Agar.io-bot/" + sha + "/launcher.user.js";
                console.log("Script: " + script1);
                window.jQuery("body").append('<script type="text/javascript" src="' + script1 + '"></script>');
                
            });
            window.jQuery.get('https://raw.githubusercontent.com/chalgoman/Agar.io-bot/master/bot.user.js?' + Math.floor((Math.random() * 1000000) + 1), function(data) {
                var latestVersion = data.replace(/(\r\n|\n|\r)/gm, "");
                latestVersion = latestVersion.substring(latestVersion.indexOf("// @version") + 11, latestVersion.indexOf("// @grant"));

                latestVersion = parseFloat(latestVersion + 0.0000);
                var script2 = "https://cdn.rawgit.com/chalgoman/Agar.io-bot/" + sha + "/bot.user.js";
            ...
            window.jQuery.get('https://raw.githubusercontent.com/chalgoman/Agar.io-bot/master/loader.user.js?' + Math.floor((Math.random() * 1000000) + 1), function(data) {
                var latestVersion = data.replace(/(\r\n|\n|\r)/gm, "");
                latestVersion = latestVersion.substring(latestVersion.indexOf("// @version") + 11, latestVersion.indexOf("// @grant"));
                ...
                if (latestVersion > myVersion) {
                    update("aposLoader", "loader.user.js", "https://github.com/chalgoman/Agar.io-bot/blob/master/loader.user.js/");
                }
